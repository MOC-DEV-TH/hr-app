...
class EmployeeWfhRequestItemView extends ConsumerWidget {
  final WfhRequestVO? wfhRequestVO;
  final ValueChanged<int> onApprove;
  final ValueChanged<int> onReject;
  final bool showMemberHeader;
  final int userId;
  const EmployeeWfhRequestItemView({super.key,this.wfhRequestVO,required this.onApprove,required this.onReject,required this.showMemberHeader,required this.userId});
          ...
          Row(
            children: [
              ...
              Visibility(
                  ...
                  child: _StatusBadge(status: wfhRequestVO?.status ?? '')),
            ],
          ),
                ...
                children: [
                  Expanded(
                    child: FilledButton.icon(
                      ...
                      onPressed: () => onReject(wfhRequestVO?.id ?? 0),
                    ),
                  ),
                  ...
                  Expanded(
                    child: FilledButton.icon(
                      ...
                      onPressed: () => onApprove(wfhRequestVO?.id ?? 0),
                    ),
                  ),
                ],
              ),
